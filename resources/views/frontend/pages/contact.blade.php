						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h2>We Are Thrilled To Connect With You!</h2>
									<h4>Instant Reach!</h4>
									<h3>Leave A Message! 
 @auth @else<span style="font-size:12px;" class="text-danger">[You need to login first]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										<div class="col-lg-12 col-12">
											<div class="form-group">
												...
												<input name="name" class="form-control" id="name" type="text" placeholder="Enter Full name">
											</div>
										</div>
										...
										<div class="col-12">
											<div class="form-group button">
												<button type="submit" style='font-family: "Raleway", sans-serif;
    font-weight: 500;
    font-size: 16px;
    letter-spacing: 1px;
    ...
    margin-top: 10px;
    color: #fff;
    background: #FB9D4A;' class="btn btn-get-started scrollto ">Submit</button>
											</div>
										</div>
									</div>
								</form>
