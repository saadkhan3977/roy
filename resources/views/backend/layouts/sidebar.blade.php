    ...
    <li class="nav-item">
        ...
        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('sub_category.index')}}">View</a>
            <a class="collapse-item" href="{{route('sub_category.create')}}">Add</a>
          </div>
        </div>

        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Child Category :</h6>
            <a class="collapse-item" href="{{route('child_category.index')}}">View</a>
            <a class="collapse-item" href="{{route('child_category.create')}}">Add</a>
          </div>
        </div>
    </li>
    {{-- Products --}}
